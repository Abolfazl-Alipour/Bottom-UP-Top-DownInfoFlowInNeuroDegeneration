...
function []= connFromSubjID(sourceFilePath,subjectID,destinationPath,locPath,locPathFrwrdMdel,chckModelConsistancy,drug,varargin)
%
%
...
% 
% % source localization
% EEG = pop_forwardModel(EEG,locPathFrwrdMdel);%, [0.33,0.022,0.33], 0,1);                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      '
% EEG = pop_rsbl(EEG, 1, 1, 'power', 'bsbl', 1);
% %putting sourcelocalized data into EEG.srcpot so that  SIFT can recognize
% %them
% EEG.srcpot=EEG.etc.src.act;
% EEG.etc=[];
% 
% 
% % selecting Sources for SIFTING
% EEG = pop_pre_prepData(EEG,'nogui','SignalType','Sources'); EEG = eeg_checkset( EEG );
% 
...
save([destinationPath,'EEGObj_',int2str(subjectID),'.mat'],'EEG')
% RPDC=EEG.CAT.Conn.RPDC;
% save([destinationPath,'RPDCMatrx_',int2str(subjectID),'.mat'],'RPDC')
